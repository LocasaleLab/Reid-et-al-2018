...
def main():
    ...
    experiment_sheet_list = [
        "HCT116_WQ2101_PHGDH", "BT20_HCT116_Raze755_PHGDH", "BT20_WQ2101_PHGDH"]
...
def output_csv_data(final_result_list_with_stderr, header_row, file_object):
    ...
    for final_result_with_stderr in final_result_list_with_stderr:
        mean_val = [str(i) for i in final_result_with_stderr[1]]
        stdev_val = [str(i) for i in final_result_with_stderr[2]]
        output_string = "{}\n{}\n{}\n".format(
            final_result_with_stderr[0], ",".join(["Average"] + mean_val),
